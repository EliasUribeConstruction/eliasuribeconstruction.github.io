...
function About() {
  return (
    <section id="about" className="scroll-my-4">
      <div className="max-w-[80%] mx-auto my-[1rem]">
        ...
        <div className="text-base sm:text-2xl font-[Poppins] text-center py-[2rem] text-blue-950">
